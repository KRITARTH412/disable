      ...
      <div className="container mx-auto">
        <Fade right>
          ...
          <p className="font-light text-lg text-black text-center mb-12 sm:mb-5 xl:mb-0">
            Discover a new standard of care where every individual is valued, supported, and empowered to thrive.
          </p>
        </Fade>
                            ...
                            <div>
                              <div className="bg-white flex flex-row items-center p-3 my-6 mx-3 sm:my-7 sm:mx-3 xl:my-14 xl:mx-7 rounded-2xl shadow-xl border border-light-theme-purple transform transition duration-500 hover:scale-105">
                                ...
                                <div className="flex-col pl-5">
                                  ...
                                  <p className="font-light text-black">{item.description}</p>
                                </div>
                              </div>
                            </div>
                          </Fade>
